...
public class GeocodeDriver {
  ...
  public static void main(String[] args) throws Exception {
	...
	Job job = Job.getInstance(conf,"Geo");
        //mi clase principal/driver
	...
	job.setMapOutputValueClass(GeocodeWritable.class);
      	...
      	//el in de la linea de comandos
	FileInputFormat.addInputPath(job, new Path(args[0]));
  	//FileInputFormat.addInputPath(job, new Path("/db"));
        //el out de la linea de comandos
